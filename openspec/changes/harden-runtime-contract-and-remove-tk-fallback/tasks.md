...
- [x] 3.2 Extract a single authoritative runtime configuration schema/loading module for the supported desktop path
- [x] 3.3 Migrate the surviving desktop runtime code to the shared config schema and keep any temporary legacy compatibility behind a thin adapter only
